...
//import com.saurabh.trading.trading_webhook.service.RealAngelOrderService; for real trading
import com.saurabh.trading.trading_webhook.service.SignalService;
...
private ExecutionOrchestrator orchestrator;
    ...
    public ResponseEntity<String> receiveWebhook(
        ...
        orderService.placeMarketOrder(payload.getTicker(), payload.getAction(), transactionType);
